...
# Area from rpt Estados
	 ...
	 $objPHPExcel->getActiveSheet()->SetCellValueByColumnAndRow(6,5,"Order Date :");
         $objPHPExcel->getActiveSheet()->SetCellValueByColumnAndRow(8,5,date("d/m/Y",strtotime($objFields['fch_ingreso'])));
	 ...
	 $objPHPExcel->getActiveSheet()->SetCellValueByColumnAndRow(3,7,$objFields['nomcliente']);
	...
	foreach($lst_details as $row)
	{
		...
		$objPHPExcel->getActiveSheet()->SetCellValueByColumnAndRow(3,$nrow,$row['nomproducto']);
